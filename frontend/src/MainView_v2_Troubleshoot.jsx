...
const MainView_v2_Troubleshoot = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const filteredData = data.filter((item) =>  // Filter for some popular cryptocurrencies
          [
            "ADAUSDT",
            "ATOMUSDT",
            "BCHUSDT",
        ...
        /*   START: Filter selected coins only  */
        ...
        /*   END: Filter selected coins only  */
...
export default MainView_v2_Troubleshoot;
